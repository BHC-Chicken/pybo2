...
urlpatterns = [
    path('list/', base_views.index, name='index'),
    path('list/<str:category_boardCode>/', base_views.index, name='index'),
    path('<int:question_id>/', base_views.detail, name='detail'),
    path('question/create/<str:category_boardCode>/', question_views.question_create, name='question_create'),
